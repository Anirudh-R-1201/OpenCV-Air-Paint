...
class Equivalence:
    def equivalence_partition(self, iterable, relation):
    ...
    def equivalence_enumeration(self, iterable, relation):
        """Partitions a set of objects into equivalence classes
    ...
    def check_equivalence_partition(self, classes, partitions, relation):
    ...
    def test_equivalence_partition(self):
